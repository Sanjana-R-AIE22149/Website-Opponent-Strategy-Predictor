...
def categorize_link(link):
    categories = {
        'Science': ['science', 'research', 'biology', 'physics', 'chemistry', 'astronomy'],
...
def main(url):
    ...
    key,value=list(categorized_links.items())[1]
    print("Central theme is",key)
    ...
    backlinks=get_backlink_counts(url)
    print(backlinks)
